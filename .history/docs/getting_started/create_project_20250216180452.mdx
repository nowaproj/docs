...
description: learn how to create your first project to startcreate a new account
slug: gett
---
 

To get your journey going with Nowa, you should first create your account
## Create your account
