...
:::note
### When you start a project, you will see this interface.
![Interface](\img\startedproject.png)
:::

## 🛠️ Toolbar  
Your main toolbox for building apps quickly and easily 🧩🚀  

- Create new pages and components in a click ✨  
- Add widgets to bring your ideas to life 🎯  
- Launch the simulator to test things instantly ▶️  

**✨ Why it’s good for you:**  
The toolbar keeps everything at your fingertips – so you can build, test, and tweak without slowing down.  

<video src="/videos/getting-started/toolbar.webm" controls width="100%" />  

## 🖼️ Screen & Widget Properties  
Easily customize how your pages and widgets look and behave 🎨⚡  

- Tweak settings to adjust style and layout ✏️  
- Control behavior to match your app’s needs 🔧  

**✨ Why it’s good for you:**  
You get full control over your app’s appearance and functionality – no extra coding needed.  

<video src="/videos/getting-started/properties.webm" controls width="100%" />  


## 📦 Variables  
Your app’s memory bank 🧠 – perfect for storing and reusing data.  

- Keep track of user input, choices, and more 📝  
- Share values between different screens and widgets 🔗  

**✨ Why it’s good for you:**  
Variables let your app feel smart and dynamic – changing and responding just like real life.  
