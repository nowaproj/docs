...
<video controls width="720">
  <source src="/img/circuit/control-flow/if/dropping-if.mp4" type="video/mp4" />
...
<video controls width="720">
  <source src="/img/circuit/control-flow/if/if-with-variable.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls width="720">
  <source src="/img/circuit/control-flow/if/operator-with-if.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
